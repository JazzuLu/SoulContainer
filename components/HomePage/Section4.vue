<template>
  <div ref="contain" class="box">
    ...
    <div class="content" style="font-size: 20px;">
      ...
      3 里根（Ragen），23 岁
      充满仇恨的人格。南斯拉夫人，讲英语时带斯拉夫口音，会塞尔维亚和克罗地亚语；武器和军事权威，精通空手道。他体格健壮，能有效地控制肾上腺素。他信奉共产主义，是个无神论者，职责是保护家庭成员，特别是妇女和儿童；在危机状况下负责管理。他曾犯罪、吸毒，有暴力倾向；体重210 磅，虎背熊腰，黑发，八字胡，色盲，只画黑白图画。
      4 亚伦（Allen），18 岁
      ...
      14 阿普里尔（April），19 岁
      女流氓。她讲话操波士顿口音，企图报复比利的继父；其他人格认为她精神不正常；会缝纫， 协助做家务。 黑发，棕眼。
      15 塞缪尔（Samuel），18 岁
      流浪的犹太人。他是个虔诚的犹太教徒，是所有人格中唯一相信神的人；雕刻家，特别擅长木雕；黑卷发、山羊胡、褐色眼睛。
      16 马克（Mark），16 岁
      工作狂。他做事被动，若无其他人格的命令，便会无所事事；负责做单调的工作，没事可做时便凝视墙壁，有时被称为“僵尸”。
      17 史蒂夫（Steve），21 岁。
      经常骗人，喜欢以模仿的方式嘲弄别人。他极端自我，是唯一不接受多重人格症诊断结果的人格；由于嘲弄人而引起众怒，并令其他人格厌烦。
      18 利伊（Lee），20 岁
      喜剧演员。小丑，喜欢捉弄人，机智。由于他的挑唆引起其他人格争吵，被狱方关入禁闭室。他对人生和自己的行为结果满不在乎；头发深棕色、眼睛栗色。
      19 杰森（Jason），13 岁
      安全阀。他经常因歇斯底里发作和脾气暴躁而招致惩罚，但能减轻压力；独自一人承受不愉快的记忆，而让其他人格忘却往事，但因此丧失了记忆；头发和眼睛均为棕色。
      20 罗伯特（鲍比，Robert），17 岁
      ...
      23 提摩西（提米 ,Timothy），15 岁。
      在花店工作。他曾遇见一位有钱的同性恋者，因恐惧而压抑自己的情感，退缩到自己的世界里。 [5]
      老师
      24 “老师”（The Teacher），26 岁。
      他是 23 种人格的融合体，为其他人格传授知识；聪明、敏感、颇具幽默感。自称“我是完整融合的比利”，称其他人格为“我创造的傀儡”；对往事拥有近乎完整的记忆。此书也因“老师”的帮助才得以完成。
    </div>
  </div>
</template>
